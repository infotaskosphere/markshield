...
# Extra headers specifically for ipindiaonline.gov.in POST requests
EFILING_HEADERS = {
    **HEADERS,
    "Origin": "https://ipindiaonline.gov.in",
    "Referer": "https://ipindiaonline.gov.in/trademarkefiling/user/frmLoginNew.aspx",
